---
name: comision-ine
description: Candidatas y candidatos del INE (México) por nombre y tipo de candidatura, desde los datos públicos de 'Candidatas y Candidatos, Conóceles'.
license: MIT
metadata:
  category: government
  locale: es-MX
...
```bash
npx -y @nomadamas/k-skill@0 instruct comision-ine
```

The CLI detects the current runtime (Dolshoi vault/CloakBrowser vs generic) and prints only the applicable instructions, always up to date. Helper files bundled with the CLI are listed by:

```bash
npx -y @nomadamas/k-skill@0 files comision-ine
```

If `npx` is unavailable, install Node.js 18+ or follow https://github.com/NomaDamas/k-skill#readme, or read the source instructions at https://github.com/NomaDamas/k-skill/blob/main/comision-ine/instruction.md.
