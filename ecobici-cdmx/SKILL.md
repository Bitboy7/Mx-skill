---
name: ecobici-cdmx
description: Estaciones de Ecobici CDMX con bicicletas disponibles cerca de una ubicación, desde el feed GBFS oficial.
license: MIT
metadata:
  category: transport
  locale: es-MX
...
```bash
npx -y @nomadamas/k-skill@0 instruct ecobici-cdmx
```

The CLI detects the current runtime (Dolshoi vault/CloakBrowser vs generic) and prints only the applicable instructions, always up to date. Helper files bundled with the CLI are listed by:

```bash
npx -y @nomadamas/k-skill@0 files ecobici-cdmx
```

If `npx` is unavailable, install Node.js 18+ or follow https://github.com/NomaDamas/k-skill#readme, or read the source instructions at https://github.com/NomaDamas/k-skill/blob/main/ecobici-cdmx/instruction.md.
