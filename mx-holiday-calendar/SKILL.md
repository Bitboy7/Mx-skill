---
name: mx-holiday-calendar
description: Días feriados oficiales de México (año actual o próximos) desde el calendario público Nager.Date, sin API key.
license: MIT
metadata:
  category: government
  locale: es-MX
...
```bash
npx -y @nomadamas/k-skill@0 instruct mx-holiday-calendar
```

The CLI detects the current runtime (Dolshoi vault/CloakBrowser vs generic) and prints only the applicable instructions, always up to date. Helper files bundled with the CLI are listed by:

```bash
npx -y @nomadamas/k-skill@0 files mx-holiday-calendar
```

If `npx` is unavailable, install Node.js 18+ or follow https://github.com/NomaDamas/k-skill#readme, or read the source instructions at https://github.com/NomaDamas/k-skill/blob/main/mx-holiday-calendar/instruction.md.
