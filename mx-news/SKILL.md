---
name: mx-news
description: Noticias de México (portada y búsqueda por palabra clave) vía el feed público RSS de Google News.
license: MIT
metadata:
  category: news
  locale: es-MX
...
```bash
npx -y @nomadamas/k-skill@0 instruct mx-news
```

The CLI detects the current runtime (Dolshoi vault/CloakBrowser vs generic) and prints only the applicable instructions, always up to date. Helper files bundled with the CLI are listed by:

```bash
npx -y @nomadamas/k-skill@0 files mx-news
```

If `npx` is unavailable, install Node.js 18+ or follow https://github.com/NomaDamas/k-skill#readme, or read the source instructions at https://github.com/NomaDamas/k-skill/blob/main/mx-news/instruction.md.
