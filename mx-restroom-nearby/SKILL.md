---
name: mx-restroom-nearby
description: Baños públicos/abiertos cerca de una ubicación en México con OpenStreetMap (Overpass API, sin API key) y geocodificación Open-Meteo.
license: MIT
metadata:
...
```bash
npx -y @nomadamas/k-skill@0 instruct mx-restroom-nearby
```

The CLI detects the current runtime (Dolshoi vault/CloakBrowser vs generic) and prints only the applicable instructions, always up to date. Helper files bundled with the CLI are listed by:

```bash
npx -y @nomadamas/k-skill@0 files mx-restroom-nearby
```

If `npx` is unavailable, install Node.js 18+ or follow https://github.com/NomaDamas/k-skill#readme, or read the source instructions at https://github.com/NomaDamas/k-skill/blob/main/mx-restroom-nearby/instruction.md.
