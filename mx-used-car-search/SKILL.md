---
name: mx-used-car-search
description: Busca autos usados/seminuevos confiables en Mexico (Seminuevos.com) con filtros e indice de confianza.
license: MIT
metadata:
  category: shopping
  locale: es-MX
...
```bash
npx -y @nomadamas/k-skill@0 instruct mx-used-car-search
```

The CLI detects the current runtime (Dolshoi vault/CloakBrowser vs generic) and prints only the applicable instructions, always up to date. Helper files bundled with the CLI are listed by:

```bash
npx -y @nomadamas/k-skill@0 files mx-used-car-search
```

If `npx` is unavailable, install Node.js 18+ or follow https://github.com/NomaDamas/k-skill#readme, or read the source instructions at https://github.com/NomaDamas/k-skill/blob/main/mx-used-car-search/instruction.md.
